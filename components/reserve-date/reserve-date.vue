	...
	<view class="content">
		<view class="body">
			<view class="head-body">
				...
				<view>
					<view class='pr40' style="display: inline-block;"><uni-icon type="arrowup" size='26' @click='prevDeta'/></view>
					<view style="display: inline-block;"><uni-icon type="arrowdown" size='26' @click='nextDate' /></view>
				</view>
			</view>
